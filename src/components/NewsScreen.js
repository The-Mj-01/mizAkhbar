...
import {
    View, Animated, Text, NetInfo, TouchableOpacity, StyleSheet, FlatList, I18nManager,
...
export default class NewsScreen extends React.Component{
    constructor(props){
        ...
        this.state={
            ...
            NightMode:false,NetworkErr:false,
            News:[]
        }
    }
    GetDataFromServer(){
        ...
        return(
            <View style={this.state.NightMode?styles.DarkContainer:styles.LightContainer}>
                ...
                <Animated.View style={[styles.TabContainer,{backgroundColor:HeadVisible}]}>
                    ...
                    <TouchableOpacity activeOpacity={.7} style={styles.TabButton}
                                      onPress={()=>this.props.navigation.push('MostComments')}>
